...
//服务器地址
#define  BSPHP_HOST  @"http://1.14.18.42/AppEn.php?appid=22222222&m=edffdb27471179819b44de0d051823b9"
//通信认证Key
#define BSPHP_MUTUALKEY @"5fe364aad5d20deff8ba4d2273b21bdb"
//接收Sgin验证 注意必须填写 并且有[KEY]
#define BSPHP_INSGIN @"[KEY]DEFRGTREDWEFG"
//输出Sgin验证 注意必须填写 并且有[KEY]
#define BSPHP_TOSGIN @"[KEY]DEFRGTREDWEFG"
//数据加密密码
#define BSPHP_PASSWORD @"ZIzzwYNTIMqIwTzEdP"
...
#define  UDID_HOST  @"http://1.14.18.42/udid/"
